    ...
    return (
        <div className="new-meeting-box">
          ...
          <div className="meeting-box-body">
            <p className="meeting-detail-title">与王先生在公司楼下星爸爸见面<span className="pull-right">重要</span><span className="circle pull-right"></span></p>


            <div className="task-line">
              <div className="task-detail-title "><span className="default">候补时间1</span></div>
              <div className="task-detail-main"><span>8月6日（周三） 8:00 至 12:00</span></div>
              <div className="task-detail-tips"><input type="checkbox"/></div>
            </div>
            <div className="task-line">
              <div className="task-detail-title "><span className="default">候补时间2</span></div>
              <div className="task-detail-main"><span>8月7日（周四） 8:00 至 12:00</span></div>
              <div className="task-detail-tips"><input type="checkbox"/></div>
            </div>
            <div className="task-line">
              <div className="task-detail-title "><span className="default">候补时间3</span></div>
              <div className="task-detail-main"><span>8月7日（周四） 8:00 至 12:00</span></div>
              <div className="task-detail-tips"><input type="checkbox" /></div>
            </div>
